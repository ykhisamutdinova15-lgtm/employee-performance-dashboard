...
Позволяет:
* Анализировать распределение сотрудников по типам эффективности;
* Оценивать выполнение KPI и динамику показателей;
* Выявлять группы с высокой долей низкоэффективных сотрудников и отрицательной динамикой KPI;
* Анализировать результаты в разрезе контактных центров и групп;
* Использовать интерактивную фильтрацию для анализа выбранного КЦ, группы или KPI.

(./images/1_report_overview.png)
...
* Сопоставлять результаты и динамику KPI с итоговой категорией эффективности;
* Сравнивать текущую и предыдущую категорию эффективности сотрудника;
* Использовать фильтрацию для поиска и анализа отдельных сотрудников.

(./images/2_report_details.png)

**Основные возможности отчета:**
* Интерактивная фильтрация данных;
* Анализ результатов по контактным центрам и группам;
* Детализация до уровня отдельного сотрудника;
* Автоматическое отображение истории KPI за последние четыре месяца;
* Использование подготовленной SQL-витрины как единого источника расчетных показателей для Power BI.
