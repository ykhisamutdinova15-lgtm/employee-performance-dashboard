...
* Выявление низкоэффективных сотрудников и групп с проблемными результатами;
* Анализ результатов на уровне КЦ, групп и отдельных сотрудников;
* Переход от сводных результатов к детализации показателей конкретного сотрудника;
...
<table style="width: 100%; max-width: 1200px; margin: 20px auto; border-collapse: collapse; table-layout: fixed; font-family: Arial, sans-serif; font-size: 14px;">
  <thead>
    ...
    <tr>
      <th>Тип эффективности</th>
      <th>0 KPI из 4 выполняется</th>
      <th>1 KPI из 4 выполняется</th>
      <th>2 KPI из 4 выполняется</th>
      <th>3 KPI из 4 выполняется</th>
      <th>4 KPI из 4 выполняется</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="padding: 12px 8px; vertical-align: middle; word-wrap: break-word; font-weight: bold;">
        <strong>🟢Высокоэффективные,</strong><br>требуется поддержание текущих показателей и развитие новых навыков
      </td>
      <td align=center>—</td>
      <td align=center>—</td>
      <td align=center>—</td>
      <td>Есть положительная динамика в показателе который не выполняется.</td>
      <td>Динамика не оценивается, так как все показатели выполнены.</td>
    </tr>
    <tr>
      <td style="padding: 12px 8px; vertical-align: middle; word-wrap: break-word; font-weight: bold;">
        <strong>🟡Среднеэффективные,</strong><br>требуется развитие
      </td>
      <td>В 2 и более показателях есть положительная динамика.</td>
      <td>В 2 и более показателях есть положительная динамика.</td>
      <td>В 2 показателях есть положительная динамика.</td>
      <td>В не выполненном показателе нет положительной динамики.</td>
      <td align=center>—</td>
    </tr>
    <tr>
      <td>
        <strong>🔴Низкоэффективные,</strong><br>требуется углубленное развитие
      </td>
      <td>Положительная динамика есть либо только в 1 показателе, либо нет динамики ни в одном показателе.</td>
      <td>Положительная динамика есть либо только в 1 показателе, либо нет динамики ни в одном показателе.</td>
      <td>Положительная динамика есть только в 1 показателе, либо нет динамики ни в одном показателе.</td>
      <td align=center>—</td>
      <td align=center>—</td>
    </tr>
  </tbody>
...
* **Динамика оценивается** — только для показателей которые не достигли таргета.
