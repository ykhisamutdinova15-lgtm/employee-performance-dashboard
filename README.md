...
Для автоматизации оценки эффективности сотрудников был разработан единый SQL-скрипт, реализующий полный цикл подготовки данных для последующей визуализации в Power BI.
[Посмотреть полный SQL-скрипт](./sql/employee_performance.sql)
