...
<table>
  <thead>
    <tr>
      <th colspan="6">Матрица классификации эффективности</th>
    </tr>
    <tr>
      <th>Категория</th>
  ...
  <tbody>
    <tr>
      <td><strong>🟢 Успешный</strong><br><br>Требуется поддержание текущих показателей и развитие новых навыков</td>
      <td>—</td>
      <td>—</td>
      <td>—</td>
    ...
    <tr>
      <td><strong>🟡 Наблюдается улучшение</strong><br><br>Требуется развитие</td>
    ...
    <tr>
      <td><strong>🔴 Требуется углубленное развитие</strong></td>
...
<table style="width:100%; table-layout:fixed;">
  <thead>
    <tr>
      <th colspan="6" style="text-align:center;">Матрица классификации эффективности</th>
    </tr>
    <tr>
      <th style="text-align:center;">Категория</th>
      <th style="text-align:center;">0 из 4<br>выполняется</th>
      <th style="text-align:center;">1 из 4<br>выполняется</th>
      <th style="text-align:center;">2 из 4<br>выполняется</th>
      <th style="text-align:center;">3 из 4<br>выполняется</th>
      <th style="text-align:center;">4 из 4<br>выполняется</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <strong>🟢 Успешный</strong><br><br>
        Требуется поддержание текущих показателей и развитие новых навыков
      </td>
      <td style="text-align:center; vertical-align:middle;">—</td>
      <td style="text-align:center; vertical-align:middle;">—</td>
      <td style="text-align:center; vertical-align:middle;">—</td>
      <td>
        Если три показателя выполняются и есть динамика в показателе,
        который не достигается.
      </td>
      <td>
        Выполняются все показатели.
      </td>
    </tr>

    <tr>
      <td>
        <strong>🟡 Наблюдается улучшение</strong><br><br>
        Требуется развитие
      </td>
      <td>
        Выполняется 0 показателей, а также в 2 и более показателях
        есть положительная динамика.
      </td>
      <td>
        Выполняется 1 показатель, а также в 2 и более показателях
        есть положительная динамика.
      </td>
      <td>
        Выполняется 2 показателя и в 2 показателях есть
        положительная динамика.
      </td>
      <td>
        Выполняется 3 показателя и в 1 показателе нет динамики.
      </td>
      <td style="text-align:center; vertical-align:middle;">—</td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Выполняется 0 показателей, положительная динамика есть
        либо только в 1 показателе, либо нет динамики ни в одном показателе.
      </td>
      <td>
        Выполняется 1 показатель и есть положительная динамика
        либо только в 1 показателе, либо нет динамики ни в одном показателе.
      </td>
      <td>
        Выполняется 2 показателя и есть положительная динамика
        только в 1 показателе, либо нет динамики ни в одном показателе.
      </td>
      <td style="text-align:center; vertical-align:middle;">—</td>
      <td style="text-align:center; vertical-align:middle;">—</td>
    </tr>
