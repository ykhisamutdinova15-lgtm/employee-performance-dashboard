...
|-|-|-|
|Results|600|Содержит фактические результаты сотрудников по четырем KPI за каждый отчетный месяц. <br />Одна запись соответствует одному сотруднику за один отчетный период.|
